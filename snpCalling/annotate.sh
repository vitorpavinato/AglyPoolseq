...
bcftools concat \
${wd}/sub_bcfs/dest.June14_2020.${maf}.2L.bcf \
${wd}/sub_bcfs/dest.June14_2020.${maf}.2R.bcf \
${wd}/sub_bcfs/dest.June14_2020.${maf}.3L.bcf \
${wd}/sub_bcfs/dest.June14_2020.${maf}.3R.bcf \
${wd}/sub_bcfs/dest.June14_2020.${maf}.X.bcf \
${wd}/sub_bcfs/dest.June14_2020.${maf}.4.bcf \
${wd}/sub_bcfs/dest.June14_2020.${maf}.Y.bcf \
-n \
