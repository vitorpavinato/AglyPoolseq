...
export wd="/fs/scratch/PAS1715/aphidpool"
...
echo "run"
  ...
  runPoolGen () {
    ...
    [ ! -d /fs/scratch/PAS1715/aphidpool/PoolGenOut_PoolSNP/${popName} ] && mkdir -p /fs/scratch/PAS1715/aphidpool/PoolGenOut_PoolSNP/${popName}
