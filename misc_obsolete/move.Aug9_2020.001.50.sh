...
### sbatch ${wd}/DEST/misc_obsolete/move.Aug9_2020.001.50.sh
sacct -j 14318111

wd="/scratch/aob2x/dest"
rsync ${wd}/dest.Aug9_2020.001.50.ann.gds /project/berglandlab/DEST/
rsync ${wd}/dest.Aug9_2020.001.50.ann.vcf.gz /project/berglandlab/DEST/
rsync ${wd}/dest.Aug9_2020.001.50.ann.vcf.gz.tbi /project/berglandlab/DEST/
