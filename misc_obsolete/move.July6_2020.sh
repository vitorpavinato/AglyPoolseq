...
rsync ${wd}/dest.July6_2020.001.10.ann.vcf.gz /project/berglandlab/DEST/
rsync ${wd}/dest.July6_2020.001.10.ann.vcf.gz.tbi /project/berglandlab/DEST/
rsync ${wd}/dest.July6_2020.001.10.header.bcf /project/berglandlab/DEST/dest.July6_2020.001.10.bcf
